...
export const ICONS = {
  ...
  /** v15.2 保暖 (覆蓋法): a sapling with a mulch mound of leaves and straw over the soil round its roots. */
  mulch: s('<path d="M12 13V6.5"/><path d="M12 9c0-2.4-1.7-4-4.3-4 0 2.5 1.7 4 4.3 4z" fill="currentColor" fill-opacity=".2"/><path d="M2.5 20.5h19"/><path d="M4 20.5c.8-3.6 4.1-6 8-6s7.2 2.4 8 6z" fill="currentColor" fill-opacity=".22"/><path d="M6.8 17.8l2.6-1.2M10.6 18.6l3.2-.9M15 17.2l2.4 1.4"/><path d="M8.2 19.4c.6-.9 1.6-1.1 2.3-.5-.7.8-1.6 1-2.3.5zM14.6 19.6c.5-.8 1.4-1 2-.5-.6.7-1.4.9-2 .5z" fill="currentColor"/>'),
